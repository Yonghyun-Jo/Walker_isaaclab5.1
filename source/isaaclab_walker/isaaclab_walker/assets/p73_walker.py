...
P73_CFG = ArticulationCfg(
    ...
    actuators={
        "walker_motors": DelayedPDActuatorLUTCfg(
            ...
            # Friction parameters from PACE system identification (Best parameter set).
            # Order in the source tensor (per PACE output, Isaac joint order):
